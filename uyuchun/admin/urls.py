...
urlpatterns = [
    ...
    path('catalog/subcategories/<int:subcategory_id>/specifications/add/', views.subcategoryspecification_create,
         name='subcategoryspecification_create'),
    path('catalog/subcategories/<int:subcategory_id>/specifications/<int:subcategoryspecification_id>/delete/',
         views.subcategoryspecification_delete, name='subcategoryspecification_delete'),
